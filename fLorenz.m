function LorenzValue = fLorenz(N)

a=10.0; b=8.0/3.0; c=28.0; % constant parameters
%%%%%%%%%%%
% Set initial condition, step length 
% and number of steps
%%%%%%%%%%%
y1 = zeros(1,N); y2 = zeros(1,N); y3 = zeros(1,N);
y1(1)=4.00000000000000;  y2(1)=3.00000000000000; y3(1)=5.00000000000000; % initial value
% y1(1)=3.1;  y2(1)=7.3; y3(1)=3.6;
h=0.02;
h2=h/2;
%%%%%%%%%
% Advance solution
...
LorenzValue = [y1; y2; y3];
save('C:\Users\sefa1\OneDrive\Belgeler\MATLAB\MATLAB_2020_Ocak\Image Encryption\LorenzValue.mat','LorenzValue');
end